const RefundPolicy = () => {
    return (
<section className="C-Refund-Policy-Main-Section">
        <div className="R-P-Banner-section">
            <div className="R-P-Banner-Content-Section">
                <h1 className="R-P-banner-section-h1">Refund Policy</h1>
                <img src="/images/policies/Course-RP-Bg.svg" alt="R-P-Banner-Img" className="R-P-banner-section-img Icon-floating-H" />
            </div>
        </div>
        ...
        <div className="C-Refund-Policy-content-Section">
            ...
            <p className="R-P-Main-Para">We understand that selecting the right course is a significant decision, and we want to ensure your satisfaction. That’s why we offer a 7-day refund policy for all our courses.</p>
            <h2 className="R-P-Sub-Main-Heading">How Our 7-Day Refund Policy Works</h2>
            <h3 className="R-P-Sub-Heading">1. Initiate Your Request</h3>
            <ul className="R-P-Main-Para">
                <li className="">Email our support team at <a href="mailto:info@techleadsit.com">info@techleadsit.com</a> within 7 days of enrollment.</li>
                <li>Provide details such as the course name, enrollment date, and reason for your refund request.</li>
            </ul>
            <h3 className="R-P-Sub-Heading">2. Review & Verification</h3>
            <ul className="R-P-Main-Para">
                <li>Our team will review your request within 5 business days.</li>
                <li>We may reach out for additional information or to resolve any concerns.</li>
            </ul>
            <h3 className="R-P-Sub-Heading">3. Refund Processing</h3>
            <ul className="R-P-Main-Para">
                <li>Once approved, the refund will be processed within 10 business days.</li>
                <li>The refund will be credited using the original payment method.</li>
            </ul>
            <h3 className="R-P-Sub-Heading">Important Considerations</h3>
            <p className="R-P-Sub-H-Option">Eligibility: <span className="R-P-Sub-Para">Refund requests must be submitted within 7 days of enrollment.</span></p>
            <p className="R-P-Sub-H-Option">Non-Refundable Items: <span className="R-P-Sub-Para">Courses purchased at a discount, special offer, or those already completed are not eligible for a refund.</span></p>
