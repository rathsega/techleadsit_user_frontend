        ...
        <section className="Main-Course-HP-CTA-banner Main-Course-HP-CTA-banner-cust">
            <div className="Main-Course-HP-CTA-banner-content">
                ...
                <button className="Main-Course-HP-CL-CTA-button">
                    ...
                    }}>Boost Your Career</span>
                </button>
            </div>
            <div className="Main-Course-HP-CTA-img-section">
                <img src="/images/home/Main-Course-HP-CTA-Banner-img.webp"
                    alt="Main-Course-HP-CTA-banner-img" className="img-fluid" width="327" height="430"
