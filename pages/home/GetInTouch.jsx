            ...
            <div style={{ "flex": "2" }}>
                ...
                <a href="https://maps.app.goo.gl/JM36K1D1phe5jPwK9" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}>
                    <div className="d-flex align-items-start gap-2 mt-3">
                        <img alt="Location-Icon" height="56" width="56" className="Main-Course-Home-Page-Get-In-Touch-Icon-S" src="/images/courses/Main-Course-Get-In-Touch-Our-Location-Icon.svg" />
                        <div>
