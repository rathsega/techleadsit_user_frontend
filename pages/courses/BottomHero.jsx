        ...
        <section className="All-category-CTA-banner">
            <div className="All-category-CTA-banner-content">
                ...
                <button className="CL-CTA-button" onClick={()=>openForm("Join The Course")}>
                    <div className="CL-CTA-button-dots_border"></div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="CL-CTA-button-sparkle">
                    ...
                    <span className="CL-CTA-button-text_button">Join The Course</span>
                </button>
            </div>
            <div className="All-category-img-section">
                <img src="/images/courses/All-category-CTA-Banner.svg" alt="All-category-CTA-banner-img" className="img-fluid" width="327" height="430"
