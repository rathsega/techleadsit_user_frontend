const QuickCall = () => {
    return (
        <a href="tel:+918125323232" aria-label="Quick call">
            <button className="Quick-Call-MB-button">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" viewBox="0 0 32 32" height="28" fill="none" className="svg-icon">
                    <path strokeWidth="2" strokeLinecap="round" stroke="#fff" fillRule="evenodd"
