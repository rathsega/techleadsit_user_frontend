...
const IsthisCourseRightForYou = React.memo(({ data, id }) => {
    return (
        <section className="Is-this-course-right-for-you-Section">
            <h3 className="Is-this-course-right-for-you-M-Heading mb-2 text-center">
                { id=='ORF-FIN-OT-003' ? 'Is This Oracle Fusion Financials Online Training Perfect for Your Career Path?' :  'Is This Course Right for You?'}
            </h3>
                ...
                <div className="Is-This-Course-Right-Segment">
                    <div className="d-flex align-items-flex-start mb-4 mb-md-2">
                        <Image priority={false} loading="lazy" src="/images/courses/Fresher-Graduates-icon.svg"
                            ...
                            width="24" />
                        <h4 className="Is-This-Course-Right-Heading">
