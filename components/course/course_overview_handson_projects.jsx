...
const CourseOverviewHandsonProjects = React.memo(({id, openForm}) => {
    const projectForFreshers = {
        ...
        "ORF-APX-OT-044" : ["This project equips freshers with end-to-end APEX workflows, module-wise app configurations, business transactions, and real-time low-code use cases while covering market-standard interview topics—enabling them to apply theoretical knowledge in practical scenarios and confidently tackle industry challenges.", "By the end of this project, freshers will have built a strong foundation in Oracle APEX and Redwood UI, gained hands-on exposure to real-world enterprise challenges, and enhanced their problem-solving abilities—making them well-prepared for job interviews and real-time low-code & ERP implementations."]
    }
    const projectForProfessionals = {
        ...
        "ORF-MFP-OT-042" : ["This project equips Oracle Fusion Manufacturing, Planning & Quality techno-functional professionals with the expertise to manage production, planning, and quality operations effectively. With real-time use cases, business scenarios, and hands-on exercises, participants gain confidence in handling end-to-end Fusion implementations. \n They will not only grasp key concepts but also master work order execution, process automation, quality inspection setup, and best practices in live ERP environments. A major focus is on the Oracle Unified Methodology (OUM) lifecycle — covering Initiation, Elaboration, Construction, Transition, and Production. To enhance learning, real-time templates aligned with each OUM phase will be provided, ensuring structured, industry-standard Fusion implementations."],
        "ORF-APX-OT-044" : ["This project equips Oracle APEX professionals with the expertise to handle complex enterprise requirements across multiple business verticals. With real-time low-code use cases, ERP-grade business scenarios, and hands-on APEX development, participants gain confidence in navigating modern cloud environments effectively.","They will not only strengthen advanced APEX concepts but also master troubleshooting, performance tuning, process optimization, and best practices used in live enterprise systems. A major focus includes APEX project lifecycle—covering design, build, integration, testing, and deployment on OCI. To enhance learning, real-time templates aligned with ERP workflows, REST API integrations, and Redwood UI standards will be provided, ensuring structured, industry-grade implementations."]
    }
    return (
