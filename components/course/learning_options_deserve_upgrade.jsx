...
const LearningOptionsDeserveUpgrade = React.memo(({ courseTitle }) => {
    ...
    return (
        <section className="Main-Course-CTA-banner4">
            <div className="Main-Course-CTA-banner-content6">
                <h2 className="Main-Course-CTA-banner-h4">
                    Your Resume Deserves an Upgrade Start Learning Today!
                </h2>
                ...
                <form className="contact-form Contact-Form-Banner-4" onSubmit={handleSubmit} noValidate>
                    <div className="Form-input-info-Container">
                        <input className="Form-input-info-fullname Form-input-info-fullname-banner-4 Form-Input-Common-Info" type="text"
                            name="fullName"
                            placeholder=" "
                            value={formData.fullName}
                            onChange={handleChange}
                            required />
                        <label for="full-name" className="Form-input-label">Full Name<span className="required">*</span></label>
                    ...
                    <div className="Form-input-info-Container">
                        <input className="Form-input-info-email Form-input-info-email-banner-4 Form-Input-Common-Info" type="email"
                            ...
                            onChange={handleChange}
                            required />
                        <label for="email" className="Form-input-label">Email<span className="required">*</span></label>
                    ...
                    <div className="Form-input-info-Container">
                        <PhoneInput
                            ...
                            className="Form-input-info-country Form-input-info-country-banner-4 demo_register_phone request_for_more_info_phone"
                            name="phone"
                    ...
                    <button className="Main-Course-CTA-button4" type="submit">
                        <div className="Main-Course-CTA-button-dots_border4"></div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="Main-Course-CTA-button-sparkle4">
                        ...
                        <span className="Main-Course-CTA-button-text_button4">Boost Your Career</span>
                    </button>
                </form>
            ...
            <div className="Main-Course-CTA-img-section4">
                <img loading="lazy" src="/images/courses/Main-Course-CTA-Banner-4.webp" alt="Main-Course-CTA-banner-img" className="img-fluid" width="345" height="480" style={{ "color": "transparent", "maxWidth": "100%", "width": "auto", "height": "auto" }} />
            </div>
        </section>
    );
});

export default LearningOptionsDeserveUpgrade;